...
if(((array_key_exists($login_admin, $_SESSION) && (isset($_SESSION[$login_admin]['active']) || @$_SESSION[$login_admin]['active'] == true))) && $myPermissions==false)
{	
...
/* Kiểm tra phân quyền */
if((isset($config['permission']) && $config['permission'] == true && isset($_SESSION[$login_admin]['active']) && $_SESSION[$login_admin]['active'] == true) && $myPermissions==false)
{
	/* Lấy quyền */
